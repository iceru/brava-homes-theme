        ...
        <div class="row">
            <section class="about-grid">
                <div class="row item">
                    <div class="col-12 col-lg-6 item-text">
                        ...
                        <div class="text">
                            ...
                            create
                            not only ‘accessible luxury’ homes of good quality, but also functional and sustainable,
                            value
                    ...
                    <div class="col-12 col-lg-6 item-img">
                        <img src="<?php bloginfo('template_directory');?>/images/index/about-grid-1.png"
                            alt="Brava Homes">
                    </div>
                </div>
                ...
                <div class="row item blue">
                    ...
                    <div class="col-12 col-lg-6 item-img">
                        <img src="<?php bloginfo('template_directory');?>/images/index/about-grid-3.png"
                            alt="Brava Homes">
                    </div>
                </div>
            </section>
